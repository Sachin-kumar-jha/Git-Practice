...
export default function Hero(){
  return (
    ...
    <div className="main  w-full py-10  md:p-10 sm:p-10">
        <div  className=" w-full mt-3 sm:p-4 md:p-4 relative w-full text-center">
         <h1 className="py-5 text-4xl  md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-900 ">Revolutionizing Traditional Mala Making Through Innovation</h1>
